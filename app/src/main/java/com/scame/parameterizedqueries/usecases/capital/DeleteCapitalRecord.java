...
public class DeleteCapitalRecord extends UseCaseCompletable {

    private CapitalRepository capitalRepository;

    private CapitalModel capitalModel;

    public DeleteCapitalRecord(SubscribeOn subscribeOn, ObserveOn observeOn, CapitalRepository capitalRepository) {
    ...
    protected Completable getUseCaseCompletable() {
        return capitalRepository.deleteCapital(capitalModel);
    }
